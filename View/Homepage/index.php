        ...
        <div class="swiper overflow-visible">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <figure class="rounded"><img src="<?= $base_url ?>Public/assets/homepage/img/photos/cf1.jpg" alt="" /><a class="item-link" href="<?= $base_url ?>Public/assets/homepage/img/photos/cf1.jpg" data-glightbox data-gallery="gallery-group"><i class="uil uil-focus-add"></i></a></figure>
            </div>
            <!--/.swiper-slide -->
            <div class="swiper-slide">
              <figure class="rounded"><img src="<?= $base_url ?>Public/assets/homepage/img/photos/cf2.jpg" alt="" /><a class="item-link" href="<?= $base_url ?>Public/assets/homepage/img/photos/cf2.jpg" data-glightbox data-gallery="gallery-group"><i class="uil uil-focus-add"></i></a></figure>
            </div>
            <!--/.swiper-slide -->
            <div class="swiper-slide">
              <figure class="rounded"><img src="<?= $base_url ?>Public/assets/homepage/img/photos/cf3.jpg" alt="" /><a class="item-link" href="<?= $base_url ?>Public/assets/homepage/img/photos/cf3.jpg" data-glightbox data-gallery="gallery-group"><i class="uil uil-focus-add"></i></a></figure>
            </div>
            <!--/.swiper-slide -->
            <div class="swiper-slide">
              <figure class="rounded"><img src="<?= $base_url ?>Public/assets/homepage/img/photos/cf4.jpg" alt="" /><a class="item-link" href="<?= $base_url ?>Public/assets/homepage/img/photos/cf4.jpg" data-glightbox data-gallery="gallery-group"><i class="uil uil-focus-add"></i></a></figure>
            </div>
            <!--/.swiper-slide -->
            <div class="swiper-slide">
              <figure class="rounded"><img src="<?= $base_url ?>Public/assets/homepage/img/photos/cf5.jpg" alt="" /><a class="item-link" href="<?= $base_url ?>Public/assets/homepage/img/photos/cf5.jpg" data-glightbox data-gallery="gallery-group"><i class="uil uil-focus-add"></i></a></figure>
            </div>
            <!--/.swiper-slide -->
            <div class="swiper-slide">
              <figure class="rounded"><img src="<?= $base_url ?>Public/assets/homepage/img/photos/cf6.jpg" alt="" /><a class="item-link" href="<?= $base_url ?>Public/assets/homepage/img/photos/cf6.jpg" data-glightbox data-gallery="gallery-group"><i class="uil uil-focus-add"></i></a></figure>
            </div>
            <!--/.swiper-slide -->
          </div>
          <!--/.swiper-wrapper -->
...
<section id="services">
          ...
          <div class="row g-6 text-center">
            <div class="col-md-6">
              <div class="card shadow-lg mb-6">
                <figure class="card-img-top overlay overlay-1">
                  <a href="#"><img class="img-fluid" src="<?= $base_url ?>Public/assets/homepage/img/photos/fs4.jpg" alt="" /></a>
                  <figcaption>
              ...
              <div class="card shadow-lg">
                <figure class="card-img-top overlay overlay-1">
                  <a href="#"><img class="img-fluid" src="<?= $base_url ?>Public/assets/homepage/img/photos/fs6.jpg" alt="" /></a>
                  <figcaption>
                    <h5 class="from-top mb-0">View Gallery</h5>
                  </figcaption>
                </figure>
            ...
            <div class="col-md-6">
              <div class="card shadow-lg mt-md-6 mb-6">
                <figure class="card-img-top overlay overlay-1">
                  <a href="#"><img class="img-fluid" src="<?= $base_url ?>Public/assets/homepage/img/photos/fs5.jpg" alt="" /></a>
                  <figcaption>
                    <h5 class="from-top mb-0">View Gallery</h5>
                  </figcaption>
                </figure>
              ...
              <div class="card shadow-lg">
                <figure class="card-img-top overlay overlay-1">
                  <a href="#"><img class="img-fluid" src="<?= $base_url ?>Public/assets/homepage/img/photos/fs7.jpg" alt="" /></a>
                  <figcaption>
                    <h5 class="from-top mb-0">View Gallery</h5>
                  </figcaption>
                </figure>
  ...
  <!-- /section -->
<div class="wrapper image-wrapper bg-image bg-overlay text-white" data-image-src="<?= $base_url ?>Public/assets/homepage/img/photos/bg34.jpg">
      ...
      <div class="grid grid-view projects-masonry">
        ...
        <div class="row gx-md-6 gy-6 isotope">
          <div class="project item col-md-6 col-xl-4 drinks events">
            <figure class="overlay overlay-1 rounded"><a href="<?= $base_url ?>Public/assets/homepage/img/photos/pf1-full.jpg" data-glightbox data-gallery="shots-group"> <img src="<?= $base_url ?>Public/assets/homepage/img/photos/pf1.jpg" alt="" /></a>
              <figcaption>
          ...
          <div class="project item col-md-6 col-xl-4 events">
            <figure class="overlay overlay-1 rounded"><a href="<?= $base_url ?>Public/assets/homepage/img/photos/pf2-full.jpg" data-glightbox data-gallery="shots-group"> <img src="<?= $base_url ?>Public/assets/homepage/img/photos/pf2.jpg" alt="" /></a>
              <figcaption>
          ...
          <div class="project item col-md-6 col-xl-4 drinks foods">
            <figure class="overlay overlay-1 rounded"><a href="<?= $base_url ?>Public/assets/homepage/img/photos/pf3-full.jpg" data-glightbox data-gallery="shots-group"> <img src="<?= $base_url ?>Public/assets/homepage/img/photos/pf3.jpg" alt="" /></a>
              <figcaption>
          ...
          <!-- /.project -->
          <div class="project item col-md-6 col-xl-4 events">
            <figure class="overlay overlay-1 rounded"><a href="<?= $base_url ?>Public/assets/homepage/img/photos/pf4-full.jpg" data-glightbox data-gallery="shots-group"> <img src="<?= $base_url ?>Public/assets/homepage/img/photos/pf4.jpg" alt="" /></a>
              <figcaption>
          ...
          <div class="project item col-md-6 col-xl-4 pastries events">
            <figure class="overlay overlay-1 rounded"><a href="<?= $base_url ?>Public/assets/homepage/img/photos/pf5-full.jpg" data-glightbox data-gallery="shots-group"> <img src="<?= $base_url ?>Public/assets/homepage/img/photos/pf5.jpg" alt="" /></a>
              <figcaption>
          ...
          <div class="project item col-md-6 col-xl-4 foods">
            <figure class="overlay overlay-1 rounded"><a href="<?= $base_url ?>Public/assets/homepage/img/photos/pf6-full.jpg" data-glightbox data-gallery="shots-group"> <img src="<?= $base_url ?>Public/assets/homepage/img/photos/pf6.jpg" alt="" /></a>
              <figcaption>
          ...
          <div class="project item col-md-6 col-xl-4 foods drinks">
            <figure class="overlay overlay-1 rounded"><a href="<?= $base_url ?>Public/assets/homepage/img/photos/pf7-full.jpg" data-glightbox data-gallery="shots-group"> <img src="<?= $base_url ?>Public/assets/homepage/img/photos/pf7.jpg" alt="" /></a>
              <figcaption>
          ...
          <div class="project item col-md-6 col-xl-4 pastries">
            <figure class="overlay overlay-1 rounded"><a href="<?= $base_url ?>Public/assets/homepage/img/photos/pf8-full.jpg" data-glightbox data-gallery="shots-group"> <img src="<?= $base_url ?>Public/assets/homepage/img/photos/pf8.jpg" alt="" /></a>
              <figcaption>
          ...
          <!-- /.project -->
          <div class="project item col-md-6 col-xl-4 events">
            <figure class="overlay overlay-1 rounded"><a href="<?= $base_url ?>Public/assets/homepage/img/photos/pf9-full.jpg" data-glightbox data-gallery="shots-group"> <img src="<?= $base_url ?>Public/assets/homepage/img/photos/pf9.jpg" alt="" /></a>
              <figcaption>
          ...
          <!-- /.project -->
          <div class="project item col-md-6 col-xl-4 foods">
            <figure class="overlay overlay-1 rounded"><a href="<?= $base_url ?>Public/assets/homepage/img/photos/pf10-full.jpg" data-glightbox data-gallery="shots-group"> <img src="<?= $base_url ?>Public/assets/homepage/img/photos/pf10.jpg" alt="" /></a>
              <figcaption>
          ...
          <div class="project item col-md-6 col-xl-4 drinks">
            <figure class="overlay overlay-1 rounded"><a href="<?= $base_url ?>Public/assets/homepage/img/photos/pf11-full.jpg" data-glightbox data-gallery="shots-group"> <img src="<?= $base_url ?>Public/assets/homepage/img/photos/pf11.jpg" alt="" /></a>
              <figcaption>
          ...
          <!-- /.project -->
          <div class="project item col-md-6 col-xl-4 foods">
            <figure class="overlay overlay-1 rounded"><a href="<?= $base_url ?>Public/assets/homepage/img/photos/pf12-full.jpg" data-glightbox data-gallery="shots-group"> <img src="<?= $base_url ?>Public/assets/homepage/img/photos/pf12.jpg" alt="" /></a>
              <figcaption>
          ...
          <!-- /.project -->
          <div class="project item col-md-6 col-xl-4 drinks">
            <figure class="overlay overlay-1 rounded"><a href="<?= $base_url ?>Public/assets/homepage/img/photos/pf13-full.jpg" data-glightbox data-gallery="shots-group"> <img src="<?= $base_url ?>Public/assets/homepage/img/photos/pf13.jpg" alt="" /></a>
              <figcaption>
                <h5 class="from-top mb-0">Ultricies Aenean</h5>
              </figcaption>
            </figure>
...
<section id="testimonials">
  <div class="wrapper image-wrapper bg-image bg-overlay" data-image-src="<?= $base_url ?>Public/assets/homepage/img/photos/bg35.jpg">
    <div class="container py-15 py-md-17">
...
<section id="about">
    ...
    <div class="container py-14 py-md-16">
      <div class="row gx-md-8 gx-xl-12 gy-6 align-items-center">
        <div class="col-md-8 col-lg-6 order-lg-2 mx-auto">
          <div class="img-mask mask-2"><img src="<?= $base_url ?>Public/assets/homepage/img/photos/about30.jpg" alt="" /></div>
        </div>
        <!--/column -->
        <div class="col-lg-6">
  ...
  <!-- /section -->
<section id="pricing">
  <div class="wrapper image-wrapper bg-image bg-overlay" data-image-src="<?= $base_url ?>Public/assets/homepage/img/photos/bg36.jpg">
    <div class="container py-15 py-md-17">
      <div class="row">
        <div class="col-xl-9 mx-auto">
          <div class="card border-0 bg-white-900">
            <div class="card-body py-lg-13 px-lg-16">
              ...
              <form class="contact-form needs-validation" method="post" action="<?= $base_url ?>Public/assets/homepage/php/contact.php" novalidate>
