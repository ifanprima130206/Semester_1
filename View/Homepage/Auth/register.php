<?php
    ...
    if (isset($_POST['register'])){
        ...
        if ($result) {
            $_SESSION['message'] = "Register successfully, please login";
            header("Location: login.php");
        } else {
            $_SESSION['error_message'] = "User failed to register";
              ...
              <div class="row gx-0 text-center">
                ...
                <div class="col-lg-6">
                  <div class="p-10 p-md-11 p-lg-13">
                    ...
                    <h2 class="mb-3 text-start">Sign up to Mentari Bakery</h2>
                    <p class="lead mb-6 text-start">Registration takes less than a minute.</p>
                    <form action="" method="post" class="text-start mb-3">
                        <div class="form-floating mb-4">
                            <input type="text" class="form-control" name="name" placeholder="Name" id="loginName">
                        ...
                        <button type="submit" name="register" class="btn btn-primary rounded-pill btn-login w-100 mb-2">Sign Up</button>
                    </form>
                    <!-- /form -->
